...
{{Form::hidden('compra_id', $compra->id, array('id'=>'compra_id'))}}
{{Form::hidden('productos', $productos->toJson(), array('id'=>'productos'))}}
<fieldset>
	<div class="grid fluid">
		<div class="row">
		<div class="span1">
		...
		<div class="span10">
			...
			<div class="row">
				<div class="span3">
					...
					{{Form::select('tipocomprobante_id', $tiposdecomprobante, $compra->tipocomprobante_id)}}
					</div>
				</div>
				<div class="span2">
					{{Form::label('serie', 'Serie')}}
					<div class="input-control text" data-role="input-control">
					{{Form::text('serie', $compra->serie, array('placeholder'=>'E0001', 'class'=>'text-right'))}}
					</div>
				</div>
				<div class="span2">
					{{Form::label('numero', 'Número')}}
					<div class="input-control text" data-role="input-control">
					{{Form::text('numero', $compra->numero, array('placeholder'=>'0001', 'class'=>'text-right'))}}
					</div>
				</div>
				<div class="span2"></div>
				<div class="span3">
					...
					<div class="input-control text" data-role="input-control">
					{{Form::text('total', $compra->total, array('placeholder'=>'0.00', 'class'=>'text-right'))}}
					</div>
				</div>
			</div>
			<div class="row">
				<div class="span6">
					...
					{{Form::hidden('provedor_id', $compra->provedor_id)}}
					<div class="input-control text" data-role="input-control">
					{{Form::text('provedor', $compra->razonsocial, array('placeholder'=>'Ingrese RUC/NOMBRE'))}}
					</div>
				</div>
				...
				<div class="span2">
					...
					<div class="input-control text" data-role="input-control">
					{{Form::text('subtotal', $compra->subtotal, array('placeholder'=>'0.00', 'class'=>'text-right'))}}
					</div>
				</div>
				<div class="span2">
					{{Form::label('igv', 'IGV')}}
					<div class="input-control text" data-role="input-control">
					{{Form::text('igv', $compra->igv, array('placeholder'=>'0.00', 'class'=>'text-right'))}}
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="span11">
					<table class="table bordered">
						...
						<script type="text/template" id="detallecompra-template">
							<td>
								<%=productonombre%>
							</td>
							<td>
							...
							<td class="text-center">
								<a href="#" class="button info editar">
			...
			<a href="#" class="button primary" id="btn_editcompra">Guardar</a>
		</div>
		</div>
	</div>
</fieldset>
