...
<nav class="navigation-bar">
    <div class="navigation-bar-content">
        <a href="/" class="element"><span class="icon-grid-view"></span> HOTEL
        <!-- ALFONSO UGARTE -->
        <sup>1.0</sup></a>
        ...
        <ul class="element-menu" style="display: block;">
            ...
            <li>
                ...
                <ul class="dropdown-menu " data-role="dropdown">
                    ...
                    <li><a href="/caja/cobrarcredito">Cobrar Credito</a></li>
                    <li><a href="/caja/cerrar-caja">Cierre Caja</a></li>
                </ul>
            </li>
            <li>
                <a href="/habitaciones/mantenimiento">Limpieza</a>
            </li>
            <!-- <li>
...
@yield('content')
    ...
    <script src="/vendor/locales/timeago.es.js"></script>
    ...
    <script src="/js/app/models/producto.js"></script>
    <script src="/js/app/collections/productos.js"></script>
    <script src="/js/app/views/appordenes-view.js"></script>
    
    <script src="/js/app/models/productocesta.js"></script>
    <script src="/js/app/collections/productoscesta.js"></script>
    <script src="/js/app/views/productocesta-view.js"></script>
