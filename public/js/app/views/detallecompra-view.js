Hotel.Views.Detallecompra = Backbone.View.extend({
	events : {
		"click .producto":'buscarproducto',
		'change .presentacion': 'presentacionedit',
		'change .cantidad': 'cantidadnedit',
		'change .costou': 'preciounitarioedit',
		'click .info': 'guardar',
	...
	initialize : function () {
		var self = this;
		this.templateedit = _.template($('#detallecompraedit-template').html());
		self.$('.producto').focus();
	...
	renderedit : function () {
		...
		var html = this.templateedit(data);
		this.$el.html(html);
	},
